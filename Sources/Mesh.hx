...
class Mesh {
	...
	public function load() {
        ...
        projection = FastMatrix4.perspectiveProjection(45, System.windowWidth()/System.windowHeight(), 1.0, 100.0);
        view = FastMatrix4.lookAt(new FastVector3(0.0, 5.0, 0.0), new FastVector3(), new FastVector3(0.0, 1.0, 0.0));
	...
	public function render(g:Graphics) {
		...
		g.setMatrix(mvpID, projection.multmat(view));
		g.setMatrix(modelMatrixID, FastMatrix4.identity());
